      ...
      <Section className="bg-melixer-dark">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-on-scroll opacity-0">
            ...
            <p className="text-melixer-light/80 mb-6">
              We're launching with a small, curated group of founders and contributors to ensure quality connections and
              a smooth experience.
            </p>
            <p className="text-melixer-light/80 mb-8">
              Apply below to join our exclusive beta and get early access to Melixer's platform. Be part of shaping how
              the next generation of startups are built.
            </p>
